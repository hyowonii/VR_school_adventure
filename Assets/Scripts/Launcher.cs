...
public class Launcher : MonoBehaviourPunCallbacks
{
    ...
    public void Connect()
    {
        if (PhotonNetwork.CurrentRoom != null)                     // ?ÑÏû¨ room??Ï∞∏Ïó¨?òÍ≥† ?àÎäî ?ÅÌÉú?ºÎ©¥ leave
        {     
            LeaveRoom();
        }
    ...
    private void CreatePlayer()
    {
        ...
        if (roomName.tag == "Untagged") // Î°úÎπÑ ?ÖÏû•
        {
